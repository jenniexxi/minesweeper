...
function startGame() {
  ...
  document
    .querySelectorAll("#zzang td")
    .forEach((e) => e.addEventListener("click", clickLeftBoard));
  document
    .querySelectorAll("#zzang td")
    .forEach((e) => e.addEventListener("contextmenu", checkMine));
}
